...
- [x] `codex-probe --version` 返回 `0.5.0`。
...
证据目录：`acceptance-artifacts/20260623T122554Z/`。

安装 smoke：`python -m pip install .` 通过，安装后 `codex-probe --version` 返回 `codex-probe 0.5.0`。
